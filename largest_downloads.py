...
def main():
    # 1. Handle Arguments
    parser = argparse.ArgumentParser(description="Find largest files in Downloads.")
    ...
    # 4. Build Table
    table = Table(title=f"Top {len(top_files)} Largest Files in Downloads", box=box.ROUNDED)
